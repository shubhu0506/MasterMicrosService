...
public class SchoolController {
	...
	@Operation(summary = "remove school principal with Id", security = @SecurityRequirement(name = "bearerAuth"))
	@PutMapping("/removePrincipal/{schoolId}")
	public ResponseEntity<Response<SchoolRegionDto>> removeSchoolPrincipal(@PathVariable("schoolId") String schoolId) { // NOSONAR

		Response<SchoolRegionDto> response = this.schoolService.removeSchoolPrincipal(schoolId);
		return ResponseEntity.ok().body(response);
	}
